"""
### Ce que nous devons déclarer dans game (fonction principale du jeu), avant la boucle while pour pouvoir faire fonctionner l'IA ###
...
### Les appels de fonction que nous faisons dans game (fonction principale du jeu), dans la boucle while pour chacun des joueurs afin de faire fonctionner l'IA ###
